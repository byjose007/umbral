...
Proporcionar capacidades de entrega multicanal (WhatsApp Cloud API, Email, Web Push/FCM) para alertas críticas y notificaciones del sistema UMBRAL, garantizando entrega confiable con idempotencia, reintentos con backoff exponencial, destinatarios basados en rol y plantillas localizadas por idioma.
