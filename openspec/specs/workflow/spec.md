...
Gestionar el acceso de proveedores y visitantes que no son personal fijo mediante un flujo de solicitud y aprobación: una máquina de estados clara (solicitada, en revisión, aprobada, rechazada, vigente, vencida), un portal público donde iniciar la solicitud, validación de documentos requeridos como condición de aprobación, y concesión de acceso con vigencia efectiva y trazabilidad de quién decide y cuándo.
